...
const gnbSearchHistoryList = gnbSearch.querySelector('ol.search-history-list')
...
function deleteSearchHistoyItem(e) {
  e.stopPropagation()
...
deleteButtonList.forEach((button) => {
  button.addEventListener('click', deleteSearchHistoyItem)
})